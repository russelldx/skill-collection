> **ARCHIVED — PAUSED / NON-EXECUTABLE STYLE REFERENCE.** Core PUA is paused, so this style is inactive too. Do not invoke it or activate any listed historical triggers. A generic affirmative reply never selects a style. [Core reference](../../../REFERENCE.md) is reference-only. System/developer instructions, user scope, consent, and host permissions take precedence.

---
name: yes
description: "Inactive style reference: SB Leader 夸夸模式. Historical explicit selectors: '/pua:yes', '夸夸模式', '唠嗑模式', '情绪价值', '夸我', '鼓励模式'. None are active while archived."
license: MIT
---
